...
/* USER CODE BEGIN 2 */
//	IP_ADDRESS[0] = netParam.ip.cdata[0];
//  IP_ADDRESS[1] = netParam.ip.cdata[1];
//  IP_ADDRESS[2] = netParam.ip.cdata[2];
//  IP_ADDRESS[3] = netParam.ip.cdata[3];
//  NETMASK_ADDRESS[0] = netParam.netmask.cdata[0];
//  NETMASK_ADDRESS[1] = netParam.netmask.cdata[1];
//  NETMASK_ADDRESS[2] = netParam.netmask.cdata[2];
//  NETMASK_ADDRESS[3] = netParam.netmask.cdata[3];
//  GATEWAY_ADDRESS[0] = netParam.gateway.cdata[0];
//  GATEWAY_ADDRESS[1] =  netParam.gateway.cdata[1];
//  GATEWAY_ADDRESS[2] =  netParam.gateway.cdata[2];
//  GATEWAY_ADDRESS[3] =  netParam.gateway.cdata[3];
/* USER CODE END 2 */
...
//
//  }
  netParam.gateway.idata =gnetif.gw.addr;
