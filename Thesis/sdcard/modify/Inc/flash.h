...
#define FLASH_MUTEX_ADDRESS   	0x08070070 // not use
#define FLASH_TIMEOUT_ADDRESS	0x08070074
#define FLASH_TELEMETRY_ADDRESS	0x08070078
...
uint8_t createJson(char demo[30],char channel[5],char name_reg[10],char name_dev[10], uint16_t val, uint8_t time[6]);
uint8_t createJson_v1(char demo[50],char *name_dev, uint16_t val, uint8_t time[6]);
