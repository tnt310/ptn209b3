...
#define NODE_CHANNEL_1_CH_LEN		1
#define NODE_CHANNEL_1_ID_LEN		1
#define NODE_CHANNEL_1_FUNC_LEN		1
#define NODE_CHANNEL_1_REGADR_LEN	2
#define NODE_CHANNEL_1_OFFSET		NODE_CHANNEL_1_CH_LEN + NODE_CHANNEL_1_ID_LEN + NODE_CHANNEL_1_FUNC_LEN	+ NODE_CHANNEL_1_REGADR_LEN
