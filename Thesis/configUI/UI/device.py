...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1155, 709))
    ...
    def retranslateUi(self, device):
        ...
        self.label_3.setText(_translate("device", "v.1.0"))
        self.label_2.setText(_translate("device", "SOLAR GATEWAY TOOL"))
        ...
        item.setText(_translate("device", "Channel Type"))
        item = self.table.horizontalHeaderItem(8)
        item.setText(_translate("device", "Value Type"))
