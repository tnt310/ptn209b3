...
def on_connect(client, userdata, flags, rc):
    ...
    if rc == 0:
        client.subscribe("up/command/60f2db017e9fd77ea20b8c9e",qos = 0)
...
def led_state_loggle():
    global start,end,total
    text = "{\"device_id\":\"09\",\"channel_id\":\"32306\",\"command\": \"read\",\"value\": 2}"
    client.publish("down/command/60f2db017e9fd77ea20b8c9e",str(text),qos=0)  # update
