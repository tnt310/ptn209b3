...
"")
        ...
        self.statusbar = QtWidgets.QStatusBar(network)
        self.statusbar.setObjectName("statusbar")
        network.setStatusBar(self.statusbar)
        self.menubar = QtWidgets.QMenuBar(network)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1178, 26))
        self.menubar.setObjectName("menubar")
        network.setMenuBar(self.menubar)
    ...
    def retranslateUi(self, network):
        ...
        self.label_27.setText(_translate("network", "NETMASK"))
        self.label_28.setText(_translate("network", "GATEWAY"))
        self.connect_3.setText(_translate("network", "UPDATE"))
        self.lineEdit_5.setText(_translate("network", "NULL"))
        self.lineEdit_6.setText(_translate("network", "NULL"))
