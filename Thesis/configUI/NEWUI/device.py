...
"")
        ...
        self.delete_2 = QtWidgets.QPushButton(self.seial_workspace)
        self.delete_2.setGeometry(QtCore.QRect(660, 560, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.delete_2.setFont(font)
        self.delete_2.setObjectName("delete_2")
        self.save = QtWidgets.QPushButton(self.seial_workspace)
        self.save.setGeometry(QtCore.QRect(450, 560, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, device):
        ...
        self.delete_2.setText(_translate("device", "DELETE DEVICE"))
        self.save.setText(_translate("device", "SAVE"))
