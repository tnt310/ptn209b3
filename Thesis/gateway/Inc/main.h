...
typedef struct{
	char *name;   // CH1_SEN2_HUMD
	char *type;   // number or string
	char *alias;  // name of address register
}xQueueProvision_t;

enum {
	SYS_START, SYS_NET_TIME,SYS_CORE_DISCOV,SYS_MQTT,SYS_HTTP ,SYS_MB_PROTOCOL, SYS_MB_APP,SYS_MB_DOWNLINK, SYS_DEFAULT
};
