...
extern data1_t table1[] =   // CHANNEL 1
{
		...
		2,	3, 	3,	7,	"CH1_INV1_RPOWR",	"number",		"React Power",
		2,	3,  3,	8,	"CH1_SEN1_HUMD",	"number",		"Humidity",
		2,	3,	3,	9,	"CH1_INV1_POWR",	"number",		"Power",
		2,	3,	3,	10, "CH1_SEN2_TEMP",	"number",		"Temperature",
		2,	3, 	3,  11, "CH1_SEN2_HUMD",	"number", 		"Humidity",
		2,	3,	3,	12,	"CH1_INV2_POWR",	"number", 		"Power",
		2,	3,	3,	13,	"CH1_SEN1_LUME",	"number",		"Lumen",
		2,	3,	3,	14,	"CH1_INV1_CURR",	"number",		"Current",
		2,	3,	3,	15,	"CH1_INV1_VOLT",	"number",		"Voltage",
		2,	3,  3, 	16,	"CH1_INV1_POWR",	"number",		"Power",
		2,	3, 	3,	17,	"CH1_INV1_RPOWR",	"number",		"React Power",
...
//		2,	9,	3,	1,	"CH3_INV1_CURR",	"number",		"Current",
//		2,	9,	3,	2,	"CH3_INV1_VOLT",	"number",		"Voltage",
//		2,	9,  3, 	3,	"CH3_INV1_POWR",	"number",		"Power",
//		2,	9, 	3,	4,	"CH3_INV1_RPOWR",	"number",		"React Power",
//		2,	9,	3,	5,	"CH3_SEN1_HUMD",	"number",		"Humidity",
//		2,	9,	3,	6,	"CH3_INV1_POWR",	"number",		"Power"
};
